...
public class DegradeController {
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        ...
        try {
            List<DegradeRuleEntity> rules = this.getNacosRules(app, ip, port);
    ...
    private boolean publishRulesToNacos(String app, String ip, Integer port) {
        ...
        try {
            ...
            logger.error("Error when publishing degrade rules to Nacos", e);
            return false;
        }
    }
     ...
     * @throws Exception
     */
    private List<DegradeRuleEntity> getNacosRules(String app,
                                                  String ip,
                                                  Integer port) throws Exception {
        List<DegradeRuleEntity> rules = this.getNacosRules(app);
     ...
     * @throws Exception
     */
    private List<DegradeRuleEntity> getNacosRules(String app) throws Exception {
